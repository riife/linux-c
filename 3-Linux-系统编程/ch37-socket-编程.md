...
有关 setsockopt 可以设置的其它选项请参考 _UNP_ 第 7 章。
...
下图是典型的 UDP 客户端/服务器通讯过程（该图出自 _UNPv13e_）。
...
```html
HTTP/1.1 200 OK Content-Type: image/jpg （这里是 mypic.jpg 的二进制数据）
```
